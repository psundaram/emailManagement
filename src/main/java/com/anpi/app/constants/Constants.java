...
public class Constants {
	  ...
	  /* Fetching Email Constants */
	  
	  //Value for Tag Not defined 
	  public static final String VFTDND = "VFTTND";
	  ...
	  // Dummy partner id for non-published partner
	  public static final String DUMMY_PARTNER_ID = "XXXXX";
